...
```{r,echo=FALSE,warning=F,message=FALSE,cache=F}
...
.center[  
```{r,message=F,warning=F,echo=FALSE, fig.height=6, fig.width = 9,fig.align='center',cache=F}
...
knitr::kable(exBayes,format="html",
  caption = "Estimated of excess mortality: INEI, Bayesian - weeks 12 to 34")  %>%
...
knitr::kable(exinei,format="html",
  caption = "Estimated of excess mortality: INEI, Naive - weeks 12 to 34") %>%
  kable_styling(font_size = 12,full_width=F,bootstrap_options = "hover")
...
knitr::kable(exBayes.GBD, format="html",
  caption = "Estimated of excess mortality: GBD, Bayes - weeks 12 to 34")%>%
  kable_styling(font_size = 12,full_width=F,bootstrap_options = "hover")
```
...
knitr::kable(exgbd, format="html",
  caption = "Estimated of excess mortality: GBD, Naive - weeks 12 to 34")%>%
  kable_styling(font_size = 12,full_width=F,bootstrap_options = "hover")
...
```{r,message=F,warning=F,echo=FALSE, fig.height=6, fig.width = 10,fig.align='center',cache=F}
